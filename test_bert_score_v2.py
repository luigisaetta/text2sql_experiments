...
this one is using "restricted schema"
"""
...
from config import CONNECT_ARGS, MODEL_LIST, MODEL_ENDPOINTS, TEMPERATURE, EMBED_MODEL_NAME, EMBED_ENDPOINT
...
for user_query, sql_query in tqdm(zip(USER_QUERIES, sql_queries), total=total_length):
    ...
    sql_query = generate_sql_with_models(
        user_query, RESTRICTED_SCHEMA, db_manager, llm_manager, PROMPT_TEMPLATE
    )
