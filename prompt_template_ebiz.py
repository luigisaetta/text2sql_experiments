...
#
PROMPT_TEMPLATE = f"""
YYou are an Oracle SQL expert tasked with generating accurate SQL queries based on user input, schema details, and examples. 
...
Always enclose the final SQL query with triple backticks for clarity.
